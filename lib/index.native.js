...
var hmac$1 = require('@noble/hashes/hmac');
...
ed25519__namespace.utils.randomPrivateKey;
ed25519__namespace.sync.getPublicKey;
const sign = (message, secretKey) => ed25519__namespace.sync.sign(message, secretKey.slice(0, 32));
ed25519__namespace.sync.verify;
...
const COMMON_HTTP_HEADERS = {
  'solana-client': `js/${(_process$env$npm_pack = "1.0.0") !== null && _process$env$npm_pack !== void 0 ? _process$env$npm_pack : 'UNKNOWN'}`
};
/**
...
secp256k1__namespace.utils.hmacSha256Sync = (key, ...msgs) => {
  const h = hmac$1.hmac.create(sha256$1.sha256, key);
